...
class InteractiveChatInterface:
    ...
    def agent_introduction(self, agent_type: str):
        ...
        intro = intros.get(agent_type, f"Hello! I'm the {agent_type.replace('_', ' ').title()} agent.")
    ...
    def determine_responding_agents(self, message: str) -> List[str]:
        ...
        # Keyword mapping
        keywords = {
            "branding": ["logo", "brand", "design", "visual", "identity", "color", "typography", "style guide"],
            "web_development": ["website", "web", "ar", "augmented reality", "app", "development", "code", "tech"],
            "legal": ["legal", "dba", "trademark", "registration", "compliance", "license", "contract"],
            ...
            "campaigns": ["campaign", "ads", "advertising", "facebook", "google ads", "launch", "marketing"],
    ...
    def get_contextual_response(self, agent_type: str, message: str) -> str:
        ...
        # Campaign Agent responses
            ...
            if "facebook" in message_lower or "instagram" in message_lower or "meta" in message_lower:
    ...
    def run(self):
        ...
        print(f"Messages: {len(self.session.messages)}")
        print(f"Agents consulted: {len(set(msg.agent_type for msg in self.session.messages if msg.agent_type))}")
