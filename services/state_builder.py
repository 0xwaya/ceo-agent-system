...
class CFOStateBuilder:
    ...
    def create_initial_state(
        ...
        **kwargs
        ...
        state = {
            ...
            'budget_allocated': {},
            'budget_spent': {},
            'budget_remaining': budget or AppConstants.DEFAULT_BUDGET,
    ...
    def create_from_request(request_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return CFOStateBuilder.create_initial_state(
            company_name=request_data.get('company_name') or company_info.get('company_name') or company_info.get('name'),
    ...
    def validate_state(state: Dict[str, Any]) -> tuple[bool, Optional[str]]:
        ...
        required_fields = [
            ...
            'total_budget', 'target_completion_days',
            'strategic_objectives', 'current_phase'
        ]
