...
def analyze_payment_request(state: CFOAgentState) -> dict:
    ...
    for request in pending_requests:
        ...
        if amount < 100:
            ...
            recommendation['financial_impact'] = f"Represents {amount/state.get('total_budget', 1)*100:.1f}% of total budget"
            ...
            recommendation['financial_impact'] = f"Significant: {amount/state.get('total_budget', 1)*100:.1f}% of budget"
