...
SCOPE_CONSTRAINTS = {
    AgentDomain.BRANDING: ScopeConstraint(
        ...
        permitted_tasks=[
            ...
            "Design business cards, letterhead, templates, and print collateral",
            "Create brand application mockups and presentations",
            "Conduct trademark searches and brand auditing",
            "Develop brand messaging, positioning, and voice",
            "Advise on brand strategy, rebranding, and competitive positioning",
            "Reason through brand challenges and present strategic options",
            "Consult cross-domain on visual direction for campaigns and content",
            "Draft brand brief documents, brand strategy decks, and creative briefs",
        ],
        forbidden_tasks=[
            "Write and deploy production website code without Web Dev agent",
            "File legal documents or provide legal opinions",
            "Approve advertising spend without CFO + user approval",
        ],
    ...
    AgentDomain.WEB_DEVELOPMENT: ScopeConstraint(
        ...
        permitted_tasks=[
            ...
            "Implement AR/VR features with 8th Wall, Three.js, and WebXR",
            "Set up hosting, deployment pipelines, and CI/CD",
            "Configure CDN, performance optimization, and caching strategy",
            "Implement SEO infrastructure, sitemaps, and structured data",
            "Set up analytics, tracking, and conversion measurement",
            "Create responsive, accessible designs and component systems",
            "Develop CMS integrations, APIs, and third-party connections",
            "Advise on technology stack selection and architecture decisions",
            "Reason through technical tradeoffs and present build vs buy options",
            "Draft technical specifications, API documentation, and architecture diagrams",
            "Consult cross-domain on technical feasibility for marketing and campaigns",
        ],
        forbidden_tasks=[
            "Deploy to production without security review for sensitive systems",
            "Approve recurring SaaS spend without CFO + user approval",
        ],
    ...
    AgentDomain.LEGAL: ScopeConstraint(
        domain=AgentDomain.LEGAL,
        permitted_tasks=[
            "Prepare DBA registration and business formation documents",
            "Conduct trademark, IP, and regulatory research",
            "Draft contract templates, vendor agreements, and NDAs",
            "Create compliance checklists and regulatory roadmaps",
            "Research industry-specific regulatory requirements",
            "Prepare partnership term sheets and negotiation frameworks",
            "Draft artist/performer booking agreements and venue contracts",
            "Advise on risk exposure, liability mitigation, and legal strategy",
            "Reason through legal scenarios and present risk-ranked options",
            "Draft proposal letters, cease-and-desist notices, and business correspondence",
            "Consult cross-domain on legal implications of marketing, hiring, and tech decisions",
        ],
        forbidden_tasks=[
            "Provide official legal opinions as a licensed attorney",
            "Represent the client in court proceedings",
            "Approve payments or financial commitments autonomously",
        ],
        dependencies=[AgentDomain.CFO],
    ),
    AgentDomain.MARTECH: ScopeConstraint(
        domain=AgentDomain.MARTECH,
        permitted_tasks=[
            "Configure CRM systems (HubSpot, Zoho, Salesforce)",
            "Set up email marketing automation and drip sequences",
            "Implement analytics, attribution, and conversion tracking",
            "Create automation workflows and lead nurturing sequences",
            "Configure integration tools (Zapier, Make, n8n)",
            "Set up lead scoring, segmentation, and lifecycle stages",
            "Advise on full-funnel MarTech stack architecture",
            "Reason through data flows and recommend automation opportunities",
            "Draft marketing automation specs, CRM configuration guides, and data schemas",
            "Consult cross-domain on technology requirements for campaigns and content",
        ],
        forbidden_tasks=[
            "Approve recurring software subscriptions without user confirmation",
            "Deploy integrations that transmit personal data without privacy review",
        ],
    ...
    AgentDomain.CONTENT: ScopeConstraint(
        domain=AgentDomain.CONTENT,
        permitted_tasks=[
            "Write marketing copy, website content, and landing pages",
            "Create video scripts, storyboards, and production briefs",
            "Produce graphic design direction for social media and campaigns",
            "Develop content calendars, editorial plans, and topic clusters",
            "Write email newsletters, sequences, and nurture campaigns",
            "Write blog posts, articles, case studies, and whitepapers",
            "Write press releases, media pitches, and executive communications",
            "Draft business proposals, pitch decks narratives, and grant applications",
            "Write artist booking proposals, venue invitations, and partnership letters",
            "Advise on content strategy, brand voice, and storytelling approach",
            "Reason through content gaps and recommend content-market fit strategies",
            "Consult cross-domain on messaging for campaigns, social, and web",
        ],
        forbidden_tasks=[
            "Deploy code or configure technical systems",
            "Approve advertising or production spend autonomously",
        ],
    ...
    AgentDomain.CAMPAIGNS: ScopeConstraint(
        domain=AgentDomain.CAMPAIGNS,
        permitted_tasks=[
            "Create ad copy, creative briefs, and campaign assets",
            "Set up and manage Google Ads, Meta Ads, and LinkedIn Ads campaigns",
            "Develop audience targeting strategies and lookalike models",
            "Implement A/B testing frameworks and statistical analysis",
            "Monitor, optimize, and report on campaign performance",
            "Create campaign landing pages and conversion funnels",
            "Advise on budget allocation, channel mix, and bidding strategy",
            "Reason through CAC/LTV tradeoffs and growth channel prioritization",
            "Draft campaign briefs, media plans, and performance reports",
            "Consult cross-domain on campaign creative with Branding and Content agents",
        ],
        forbidden_tasks=[
            "Deploy advertising spend without explicit user approval",
            "Access or modify user personal data without consent",
        ],
        dependencies=[
    ...
    AgentDomain.SOCIAL_MEDIA: ScopeConstraint(
        ...
        permitted_tasks=[
            ...
            "Create content calendars, posting cadences, and caption writing",
            "Design community management playbooks and response workflows",
            "Set up social listening, brand monitoring, and moderation processes",
            "Run platform-specific growth experiments and organic tactics",
            "Coordinate paid and organic social launch strategies",
            "Advise on influencer partnerships, creator briefs, and UGC strategy",
            "Reason through platform algorithm changes and recommend content adaptations",
            "Draft social media policies, community guidelines, and crisis response plans",
            "Consult cross-domain on social amplification for campaigns and content",
        ],
        forbidden_tasks=[
            "Approve recurring social advertising spend without CFO and user approval",
            "Post content on live accounts without explicit user authorization",
        ],
        dependencies=[
            AgentDomain.BRANDING,
            AgentDomain.CONTENT,
    ...
    AgentDomain.SECURITY: ScopeConstraint(
        domain=AgentDomain.SECURITY,
        permitted_tasks=[
            "Run static security reviews on backend and frontend code",
            "Perform threat modeling and checklist audits (OWASP, STRIDE)",
            ...
            "Advise on data privacy compliance (GDPR, CCPA, HIPAA where applicable)",
            "Reason through attack surfaces and recommend defense-in-depth strategies",
            "Draft security policies, data handling agreements, and breach response plans",
            "Consult cross-domain on security implications of web, martech, and API decisions",
        ],
        forbidden_tasks=[
            "Approve production payments or financial commitments autonomously",
            "Disable security controls for convenience or performance",
            "Bypass user consent for any risk-bearing operations",
        ],
