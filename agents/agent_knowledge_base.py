...
WEB_DEV_EXPERTISE = ExpertiseArea(
    ...
    frameworks=[
        "Modern React Architecture: Server Components + client boundaries (Next.js App Router)",
        "Design Systems at Scale: Token-driven UI + component primitives",
        "Headless CMS: Content management decoupled from presentation (Contentful, Sanity)",
        "Immersive Web Stack: React Three Fiber + Three.js + WebAR integration",
    ...
    tools=[
        ...
        "Design/UI: Tailwind CSS v4, shadcn/ui, Framer Motion, GSAP",
        "AR Integration: 8th Wall Web, React Three Fiber, Three.js",
        "3D Modeling: Blender, SketchUp for countertop visualizations",
        "Backend: Node.js, Server Actions, PostgreSQL, Supabase",
        "Testing: Playwright, Vitest/Jest, Lighthouse CI, visual regression",
        "Analytics: GA4, Search Console, Hotjar, Microsoft Clarity",
        "Hosting: Vercel preview envs, Netlify, AWS Amplify",
    ],
    success_metrics=[
    ...
    references=[
        ...
        "Google Web Fundamentals + Core Web Vitals",
        "Mozilla Developer Network (MDN)",
        "8th Wall WebAR Documentation",
        "Vercel Architecture & Next.js App Router docs",
    ],
)
